...
<nav class="w3-sidebar w3-collapse w3-oxford-blue w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block p-t-15">
    ...
    <a href="instant.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-hourglass-half fa-fw w3-margin-right"></i><b>INSTANT WORD</b></a>
  </div>
  <div class="w3-bar-block p-t-15">
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="projects">
    ...
    <h1 class="header-title p-t-45 p-b-45"><b>Choose the Project to collect</b></h1>
...
while ($projectAssignment = $resultAssignment->fetch_assoc()) {
    ...
    echo '<a href="choose-list.php?project_id=' . $project['project-no'] . '">';
    ...
    echo '<h4 class="w3-text-dark-grey"><i>' . $language['language-name'] . '</i></h4>';
    echo '</div>';
    echo '</div>';
    echo '</button>';
    echo '</a>';
