...
<html>
<head>
<title>Choosing Wordlists</title>
<meta charset="UTF-8">
...
?>
    ...
    <img src="images/logo-blue.png" style="height:100px;" class="w3-right w3-hide-small w3-hide-medium w3-animate-top">
        <h1 class="header-title p-t-75 p-b-45"><b>Choose the wordlist available</b></h1>
...
while ($wordlist = $resultWordlist->fetch_assoc()) {
  ...
  echo '<a href="instant-project.php?project_id=' .$projectID. '&wordlist_id=' . $wordlist['wordlist-id'] . '">';
