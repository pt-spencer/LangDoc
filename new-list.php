...
<html>
<head>
<title>Create New Wordlist</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="new-project">
    ...
    <h1 class="header-title p-t-45 p-b-45"><b>Create New Wordlist</b></h1>
  ...
  <form action="?project_id=<?= $projectId ?>" method="POST" id="wordlist-form">
  ...
  <br>
  <div class="w2-center">
    <input name="submit" type="submit" id="wordlist-pref" class="w3-button btn-outline-secondary w3-oxford-blue w3-margin-bottom" value="Submit and Return" onclick="validateForm()">
    </div>
  </form>
</div>
...
if (isset($_POST['submit'])) {
    ...
    if (isset($sqlFile)) {
        ...
        if ($mysqli->multi_query($sqlContent)) {
            $projectID = $_GET['project_id'];
            header("Location: project-home.php?project_id=$projectID");
            ob_end_flush();
            exit;
        } else {
