...
<div class="w3-main" style="margin-left:300px">
  ...
  <h3><b>Add People to Your Project</b></h3>
    ...
    <form action="complete-project.php?project_id=<?= $_GET['project_id'] ?>" class="w3-center" method="POST">
      <button name="submit" type="submit" id="invite-member" class="w3-button btn-outline-secondary w3-oxford-blue w3-margin-bottom">
      Create the Project
    </button>
    </form>
